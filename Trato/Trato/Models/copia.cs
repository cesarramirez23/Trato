...
namespace Trato.Models
{
    ...
    {
        /*
         *  app de informacion(mapa con las calles y orientarte solo simbologia,   lector de las cosas)
            videos 360 en oculus
        ...
        List<GroupFiltro> v_grupos = new List<GroupFiltro>();

        GroupFiltro v_CiudadesGroup = new GroupFiltro();
        GroupFiltro v_EspeGroup = new GroupFiltro();

        public V_Buscador()
        {
            InitializeComponent();
            //overlay.IsVisible = v_filtro;
            ListaGroup.IsVisible = v_filtro;
        }
